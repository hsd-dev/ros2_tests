...
def generate_test_description():
    ...
    return LaunchDescription([
        LogInfo(msg=[
            'Including launch file located at: ', get_package_share_directory('pub_sub_tests'), '/pub_sub_launch.py'
        ]),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([get_package_share_directory('pub_sub_tests'), '/pub_sub_launch.py']),
